...
from mani_skill.examples.motionplanning.xarm7.solutions import (solvePickCube,
...
ROBOT_UIDS_LIST = {
    "PickCube-v1": "xarm7_robotiq_wristcam",
    "PushCube-v1": "xarm7_robotiq_wristcam",
    "StackCube-v1": "xarm7_robotiq_wristcam",
    "PlugCharger-v1": "xarm7_robotiq_wristcam",
    "PullCube-v1": "xarm7_robotiq_wristcam",
    "PullCubeTool-v1": "xarm7_robotiq_wristcam",
    "DrawTriangle-v1": "xarm7_robotiq_wristcam",
    "DrawSVG-v1": "xarm7_robotiq_wristcam",
    "PlaceSphere-v1": "xarm7_robotiq_wristcam",
    "LiftPegUpright-v1": "xarm7_robotiq_wristcam",
    "PegInsertionSide-v1": "xarm7_robotiq_wristcam",
}
REWARD_MODE_LIST = {
    "PickCube-v1": "dense",
    "PushCube-v1": "dense",
...
def parse_args(args=None):
    ...
    parser.add_argument("--record-dir", type=str, default="data/xarm7", help="where to save the recorded trajectories")

...
class XArm6MotionPlanningSolver:
    def __init__(
        self,
        env: BaseEnv,
        debug: bool = False,
    ...
    def setup_planner(self):
        ...
        planner = mplib.Planner(
            ...
            move_group="stick_tcp",  # Using link6 as the end effector
            joint_vel_limits=np.ones(6) * self.joint_vel_limits,  # 6 DOFs instead of 7

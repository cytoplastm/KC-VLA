...
# from mani_skill.examples.motionplanning.xarm6.solutions import (solvePickCube,
# solvePushCube, solveStackCube, solvePlugCharger, solvePullCube, solvePullCubeTool,
# solveDrawTriangle, solveDrawSVG, solvePlaceSphere, solveLiftPegUpright, solvePegInsertionSide)
from mani_skill.examples.motionplanning.widowxai.solutions import (
    solvePickCube, 
    solvePullCube, 
    solvePushCube, 
    solveStackCube,
...
ROBOT_UIDS_LIST = {
    "PickCube-v1": "widowxai_wristcam",
    "PushCube-v1": "widowxai_wristcam",
    "StackCube-v1": "widowxai_wristcam",
    # "PlugCharger-v1": "xarm6_robotiq_wristcam",
    "PullCube-v1": "widowxai_wristcam",
    "PullCubeTool-v1": "widowxai_wristcam",
    # "DrawTriangle-v1": "xarm6_stick_wristcam",
    # "DrawSVG-v1": "xarm6_stick_wristcam",
    # "PlaceSphere-v1": "xarm6_robotiq_wristcam",
    "PlaceSphere-v1": "widowxai_wristcam",
    # "LiftPegUpright-v1": "xarm6_robotiq_wristcam",
    "PegInsertionSide-v1": "widowxai_wristcam",
    "LiftPegUpright-v1": "widowxai_wristcam",
}
REWARD_MODE_LIST = {
    "PickCube-v1": "dense",
    "PushCube-v1": "dense",
    "StackCube-v1": "dense",
    "PlugCharger-v1": "sparse",
    "PullCube-v1": "dense",
...
def parse_args(args=None):
    ...
    parser.add_argument("-e", "--env-id", type=str, default="PullCube-v1", help=f"Environment to run motion planning solver on. Available options are {list(MP_SOLUTIONS_LIST.keys())}")
    ...
    parser.add_argument("--record-dir", type=str, default="data/widowxai", help="where to save the recorded trajectories")

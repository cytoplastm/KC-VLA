...
# nohup python scripts/gr00t_finetune.py --dataset-path /home/chenyipeng/data/maniskill_data/lerobot_datasets/mixed_data/panda_wristcam --num-gpus 1 --video-backend decord --report-to tensorboard> mix_data_history=keyframe5_prompt_modify_final_version.log 2>&1 &
